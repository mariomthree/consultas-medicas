...
<div class="row mb-2">
    <div class="col-sm-6">
        <h1 class="m-0 text-dark">Actualizar Usuarios</h1>
    </div><!-- /.col -->
    <div class="col-sm-6">
...
<div class="row">
	<div class="card card-secondary" style="width: 100%;">
		...
		<div class="card-body" style="padding: 20px;">
			{!! Form::model($usuario,['method'=>'PATCH','action'=>['App\Http\Controllers\UsuarioController@update', $usuario->id],'id'=>'form','files'=>true]) !!}
			<!-- Main content -->
